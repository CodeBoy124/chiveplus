...
This can be done by first downloading the code from this github repo and then running the following in the root of the local clone. You do need to have npm installed
```console
npm install -g .
```
